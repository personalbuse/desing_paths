import { delay, printStep, printInfo, printSuccess, printSlow, printCodeBlock, printTitle, printExplanation, showSpinner } from '../utils/index.js';
/**
...
abstract class Bebida {
  ...
  protected abstract agregarIngrediente(): Promise<void>;
    ...
    async execute() {
        ...
        printExplanation('Concepto', 'Define el esqueleto de un algoritmo en una operacion, delegando algunos pasos a las subclases.');
        await delay(800);
        ...
        const te = new Te();
        await te.preparar();
        printExplanation('Beneficio', 'Permite que las subclases redefinan ciertos pasos de un algoritmo sin cambiar su estructura.');
    }
}
