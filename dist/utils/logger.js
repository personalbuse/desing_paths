...
export async function printSlow(text, speed = 20) {
...
export async function printTitle(text) {
...
export async function showSpinner(text, duration = 800) {
    const spinner = ora({
        text: chalk.dim(text),
        color: "cyan",
        spinner: "dots",
...
export function printExplanation(title, text) {
...
export function printCodeBlock(code, label = "CODE") {
    console.log(boxen(chalk.hex("#abb2bf")(code), {
